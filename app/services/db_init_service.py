        ...
        async with engine.begin() as conn:
            ...
            await conn.execute(text("""
                ...
                SELECT
                    ...
                    COALESCE(
                        ...
                        MAX(CASE WHEN acr.criterion_key = 'trato_usted' AND acr.is_applicable THEN acr.numeric_value END)) AS trato_usted
                FROM bm_analyses a
            ...
            await conn.execute(text("""
                ...
                SELECT
                    ...
                    criterion_id, criterion_key, criterion_name, criterion_type,
