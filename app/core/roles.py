...
ROLE_MAPPINGS = {
    ...
    "company_super_admin": InternalRole.COMPANY_ADMIN,
    "company_superadmin": InternalRole.COMPANY_ADMIN,
    "companysuperadmin": InternalRole.COMPANY_ADMIN,
    "company_super_administrator": InternalRole.COMPANY_ADMIN,
    "superadmin_empresa": InternalRole.COMPANY_ADMIN,
    "super_admin_empresa": InternalRole.COMPANY_ADMIN,
