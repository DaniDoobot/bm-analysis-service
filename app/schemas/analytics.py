...
class AgentInfo(BaseModel):
    ...
    agent_code: str | None = Field(None, description="Unique visible agent code (e.g. AC-F01) or name fallback")
    agent_initials: str | None = Field(None, description="Agent initials e.g. AG or AC-F01")
    initials: str | None = Field(None, description="Agent initials alias")
    label: str | None = Field(None, description="Formatted label e.g. AC-F01 · Agente Demo 01")
