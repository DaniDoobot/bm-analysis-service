...
async def seed_demo_structure(db: AsyncSession) -> Dict[str, Any]:
    ...
    # 8. Create 60 Agents
    # Distribution:
    # 01..10 -> Front Atención (10): AC-F01..AC-F10
    # 11..30 -> Backoffice Atención (20): AC-B01..AC-B20
    # 31..40 -> Equipo Comercial (10): VT-C01..VT-C10
    # 41..60 -> Equipo Retención (20): VT-R01..VT-R20
